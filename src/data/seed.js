...
export const SEED = {
  ...
  jobs: [
    {
      id: 1,
      customer: "ArcelorMittal Zenica",
      customerId: 1,
      country: "BA", city: "Zenica",
      supervisor: "Miroslav P.",
      workerName: "Emir Hadžić",
      workerLastSeen: new Date(Date.now() - 12 * 60000).toISOString(),
      lat: 44.198, lng: 17.908,
      phase: "installation",
      progress: 65,
      status: "active",
      material: "Brick ERSPIN 8003",
      plannedEnd: "15.03.2026",
      notes: "EAF hearth — zona 3 u toku",
    },
    {
      id: 2,
      customer: "HBIS Group Serbia",
      customerId: 2,
      country: "RS", city: "Smederevo",
      supervisor: "Miroslav P.",
      workerName: "Dragan Nikolić",
      workerLastSeen: new Date(Date.now() - 45 * 60000).toISOString(),
      lat: 44.658, lng: 20.935,
      phase: "dryout",
      progress: 30,
      status: "active",
      material: "CALDER GUN SUPERAL X 70",
      plannedEnd: "20.03.2026",
      notes: "BOF konvertor — sušenje po protokolu",
    },
    {
      id: 3,
      customer: "Autoflex Livnica Čoka",
      customerId: 6,
      country: "RS", city: "Čoka",
      supervisor: "Miroslav P.",
      workerName: "Zoran Kovač",
      workerLastSeen: new Date(Date.now() - 5 * 60000).toISOString(),
      lat: 45.938, lng: 20.143,
      phase: "demolition",
      progress: 80,
      status: "active",
      material: "CALDE CAST F 65",
      plannedEnd: "12.03.2026",
      notes: "IF reline — stara obloga vani",
    },
    {
      id: 4,
      customer: "Progress AD",
      customerId: 3,
      country: "BG", city: "Plovdiv",
      supervisor: "Miroslav P.",
      workerName: "Ivan Petrov",
      workerLastSeen: new Date(Date.now() - 180 * 60000).toISOString(),
      lat: 42.148, lng: 24.751,
      phase: "hse_prep",
      progress: 50,
      status: "active",
      material: "SILICA MIX 5 A 0,6",
      plannedEnd: "18.03.2026",
      notes: "Indukciona peć #3 — HSE briefing završen 50%",
    },
    {
      id: 5,
      customer: "Moravacem",
      customerId: 4,
      country: "RS", city: "Popovac",
      supervisor: "Miroslav P.",
      workerName: "Predrag Simić",
      workerLastSeen: new Date(Date.now() - 20 * 60000).toISOString(),
      lat: 43.852, lng: 21.402,
      phase: "verification",
      progress: 90,
      status: "active",
      material: "CALDE SOL CAST A 50 SZ",
      plannedEnd: "10.03.2026",
      notes: "Rotaciona peć — finalna inspekcija",
    },
    {
      id: 6,
      customer: "Berg Montana Fittings",
      customerId: 12,
      country: "BG", city: "Montana",
      supervisor: "Miroslav P.",
      workerName: "Stefan Georgiev",
      workerLastSeen: new Date(Date.now() - 120 * 60000).toISOString(),
      lat: 43.408, lng: 23.228,
      phase: "installation",
      progress: 20,
      status: "paused",
      material: "CALDE CAST T 96",
      plannedEnd: "25.03.2026",
      notes: "IF — čekamo drugi deo materijala iz Beča",
    },
  ],
  silicaGrades: [
